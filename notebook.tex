...
%    \fbox{\includegraphics[height=\textheight/3, angle=0]{1}}
%\end{figure}
%\begin{figure}[]
%    \centering
%    \fbox{\includegraphics[height=\textheight/3, angle=0]{2}}\\
%    \fbox{\includegraphics[height=\textheight/3, angle=0]{3}}\\
%    \fbox{\includegraphics[height=\textheight/3, angle=0]{4}}
%\end{figure}
%\begin{figure}[]
%    \centering
%    \fbox{\includegraphics[height=\textheight/3, angle=0]{5}}\\
%    \fbox{\includegraphics[height=\textheight/3, angle=0]{6}}\\
%    \fbox{\includegraphics[height=\textheight/3, angle=0]{7}}
%\end{figure}
